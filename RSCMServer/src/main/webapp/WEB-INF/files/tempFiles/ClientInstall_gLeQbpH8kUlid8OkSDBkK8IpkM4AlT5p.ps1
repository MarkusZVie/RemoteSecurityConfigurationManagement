...
$password =  ConvertTo-SecureString 'bY=RnkFjj!VuTw0I' -asplaintext -force
...
Start-Sleep -m 1000
$wshell.SendKeys("bY=RnkFjj!VuTw0I{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("mkdir C:\Users\rscm\.ssh{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("ssh-keygen.exe -f C:\Users\rscm\.ssh\id_rsa -N 'nyL=!7TdoU0j1HQW'{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("exit{ENTER}")
#create own keys
ssh-keygen.exe -f $HOME\.ssh\id_rsa -N 'YqW4Nd9WblTvm4KR'

$wshell2 = New-Object -ComObject Wscript.Shell
$wshell2.Run("ssh-add.exe $HOME\.ssh\id_rsa")
Start-Sleep -m 1000
$wshell2.SendKeys("YqW4Nd9WblTvm4KR{ENTER}")
...
$params = @{"applikationKey"="gLeQbpH8kUlid8OkSDBkK8IpkM4AlT5p";
