...
$password =  ConvertTo-SecureString 'KyJeHunR0!IVMaQG' -asplaintext -force
...
Start-Sleep -m 1000
$wshell.SendKeys("KyJeHunR0!IVMaQG{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("mkdir C:\Users\rscm\.ssh{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("ssh-keygen.exe -f C:\Users\rscm\.ssh\id_rsa -N 'OmbFwnTAViXMH5ee'{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("exit{ENTER}")
#create own keys
ssh-keygen.exe -f $HOME\.ssh\id_rsa -N 'Mt3gqbuRzj6k!WAw'

$wshell2 = New-Object -ComObject Wscript.Shell
$wshell2.Run("ssh-add.exe $HOME\.ssh\id_rsa")
Start-Sleep -m 1000
$wshell2.SendKeys("Mt3gqbuRzj6k!WAw{ENTER}")
...
$params = @{"applikationKey"="k6E=g1WQLTdztGYt0V1W5MedVMZaRw6w";
