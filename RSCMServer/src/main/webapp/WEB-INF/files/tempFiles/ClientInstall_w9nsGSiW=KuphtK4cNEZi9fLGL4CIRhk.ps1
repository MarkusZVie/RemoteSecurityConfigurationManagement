...
$password =  ConvertTo-SecureString 'Rnia9u9D=znKvok7' -asplaintext -force
...
Start-Sleep -m 1000
$wshell.SendKeys("Rnia9u9D=znKvok7{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("mkdir C:\Users\rscm\.ssh{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("ssh-keygen.exe -f C:\Users\rscm\.ssh\id_rsa -N 'aYbFHFSWJddw4CmZ'{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("exit{ENTER}")
#create own keys
ssh-keygen.exe -f $HOME\.ssh\id_rsa -N '9iQ5lCwm=BbX9H!U'

$wshell2 = New-Object -ComObject Wscript.Shell
$wshell2.Run("ssh-add.exe $HOME\.ssh\id_rsa")
Start-Sleep -m 1000
$wshell2.SendKeys("9iQ5lCwm=BbX9H!U{ENTER}")
...
$params = @{"applikationKey"="w9nsGSiW=KuphtK4cNEZi9fLGL4CIRhk";
