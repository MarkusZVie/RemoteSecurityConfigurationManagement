...
$password =  ConvertTo-SecureString '1PObcjWSbldcbJ4y' -asplaintext -force
...
Start-Sleep -m 1000
$wshell.SendKeys("1PObcjWSbldcbJ4y{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("mkdir C:\Users\rscm\.ssh{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("ssh-keygen.exe -f C:\Users\rscm\.ssh\id_rsa -N 'JBcRTw4lxWlbV=rk'{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("exit{ENTER}")
#create own keys
ssh-keygen.exe -f $HOME\.ssh\id_rsa -N 'nOiCY4B=ZDRAufE9'

$wshell2 = New-Object -ComObject Wscript.Shell
$wshell2.Run("ssh-add.exe $HOME\.ssh\id_rsa")
Start-Sleep -m 1000
$wshell2.SendKeys("nOiCY4B=ZDRAufE9{ENTER}")
...
$params = @{"applikationKey"="dMBDav8qYmCdG7dWIvKR76!w7E5I!Ey1";
