...
$password =  ConvertTo-SecureString '63dvQbnXB1WWyFm7' -asplaintext -force
...
Start-Sleep -m 1000
$wshell.SendKeys("63dvQbnXB1WWyFm7{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("mkdir C:\Users\rscm\.ssh{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("ssh-keygen.exe -f C:\Users\rscm\.ssh\id_rsa -N 's9nt3CuaZNApCXw='{ENTER}")
Start-Sleep -m 1000
$wshell.SendKeys("exit{ENTER}")
#create own keys
ssh-keygen.exe -f $HOME\.ssh\id_rsa -N '!kpuVdcyWf2r1XHf'

$wshell2 = New-Object -ComObject Wscript.Shell
$wshell2.Run("ssh-add.exe $HOME\.ssh\id_rsa")
Start-Sleep -m 1000
$wshell2.SendKeys("!kpuVdcyWf2r1XHf{ENTER}")
...
$params = @{"applikationKey"="nUrVvxAs29HyLS2I=l10Q2JCV3xvT5Dv";
